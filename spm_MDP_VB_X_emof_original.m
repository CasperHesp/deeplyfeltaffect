...
% adapted for affective inference from "spm_MDP_VB_X.m" from SPM12
%
...
for t = 1:T
    ...
    %======================================================================
        ...
        if 1
                ...
                mdp1.beta = (beta_pos*(O{1,t}(1))+ beta_neg*(O{1,t}(2)));
        ...
        mdp1.tau = 12;
        MDP.mdp2(t) = spm_MDP_VB_Xe_original(mdp1);
        mdp1.d = MDP.mdp2(t).d;
        ...
        if 1
            ...
            O{1,t}(1) = O{1,t}(1)*VA(1);
            O{1,t}(2) = O{1,t}(2)*VA(2);
